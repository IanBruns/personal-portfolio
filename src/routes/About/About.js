...
export default function About(props) {
    return (
        <div className='About'>
            ...
            <hr />
            <p>
                When not developing, you can usually find me spending time with friends, or listening to
                music (if you ask me to share with you what I'm listening to, prepare for an onslaught of
                good stuff).
            </p>
        </div>
    )
